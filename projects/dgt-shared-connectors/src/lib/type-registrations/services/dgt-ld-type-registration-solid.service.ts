...
export class DGTLDTypeRegistrationSolidService {
  ...
  public registerForResources(predicate: string, resource: DGTLDResource, exchange: DGTExchange): Observable<DGTLDTypeRegistration[]> {
    ...
    this.logger.debug(DGTLDTypeRegistrationSolidService.name, 'Found typeRegistrations.', { foundTypeRegistrations });
    ...
    if (resource.uri && (!foundTypeRegistrations || foundTypeRegistrations.length === 0)) {
      ...
      this.logger.debug(DGTLDTypeRegistrationSolidService.name, 'Creating the relevant typeRegistration.', { foundTypeRegistrations, resource });
      ...
      this.logger.debug(DGTLDTypeRegistrationSolidService.name, 'Returning the relevant typeRegistration.', { foundTypeRegistrations, resource });
  ...
  public register(typeRegistrations: DGTLDTypeRegistration[]): Observable<DGTLDTypeRegistration[]> {
    this.logger.debug(DGTLDTypeRegistrationSolidService.name, 'Starting to register typeRegistration.', { typeRegistrations });
