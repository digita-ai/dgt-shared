...
export class DocumentComponent extends BaseComponent {
  ...
  @property() documents?: { url: string; fileName: string }[] = [ { url: 'https://schema.org/educationalLevel', fileName: 'educational level' }, { url: 'https://schema.org/competencyRequired', fileName: 'comptency required' } ];
  @property() url?: string;
