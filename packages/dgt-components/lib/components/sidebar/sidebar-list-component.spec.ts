...
describe('SidebarListComponent', () => {
  ...
  it('should call select when select is clicked 2', async () => {
    ...
    const select = window.document.body.getElementsByTagName('sidebar-list')[0].shadowRoot.querySelector('slot[name="item"]') ;
    select.click();
