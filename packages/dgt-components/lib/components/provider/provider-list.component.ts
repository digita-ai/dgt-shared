  ...
  render(): TemplateResult {
    ...
    return html`
      ...
      <div class="providers">
        ...
        <provider-list-item exportparts="provider" @button-clicked="${this.onIssuerSelected(provider)}" .icon="${provider.icon}" .description="${provider.description}" ?buttonEnabled=${this.buttonsEnabled}></provider-list-item>
        `)}
      </div>
